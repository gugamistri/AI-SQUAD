...
- `==================== START: .ai-squad-core/folder/filename.md ====================`
- `==================== END: .ai-squad-core/folder/filename.md ====================`

When you need to reference a resource mentioned in your instructions:

- Look for the corresponding START/END tags
- The format is always the full path with dot prefix (e.g., `.ai-squad-core/personas/analyst.md`, `.ai-squad-core/tasks/create-story.md`)
...
- `dependencies.utils: template-format` → Look for `==================== START: .ai-squad-core/utils/template-format.md ====================`
- `dependencies.utils: create-story` → Look for `==================== START: .ai-squad-core/tasks/create-story.md ====================`
