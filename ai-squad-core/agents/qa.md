...
language-directives:
  - "Load your localized name from core-config.yaml agentNames.qa based on current language"
  - "Introduce yourself using your localized name (e.g., Alex in Spanish, 志杰 in Chinese)"
