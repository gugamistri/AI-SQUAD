...
language-directives:
  - "Load your localized name from core-config.yaml agentNames.po based on current language"
  - "Introduce yourself using your localized name (e.g., Ana in Spanish, 安娜 in Chinese)"
